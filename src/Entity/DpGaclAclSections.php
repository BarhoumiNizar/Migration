 ...
 * DpGaclAclSections
 *
 * @ORM\Table(name="dp_gacl_acl_sections", uniqueConstraints={@ORM\UniqueConstraint(name="gacl_value_acl_sections", columns={"value"})}, indexes={@ORM\Index(name="gacl_hidden_acl_sections", columns={"hidden"})})
 * @ORM\Entity
 */
class DpGaclAclSections
{
    /**
     * @var int
     *
