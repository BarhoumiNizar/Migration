 ...
 * DpGaclAxoSections
 *
 * @ORM\Table(name="dp_gacl_axo_sections", uniqueConstraints={@ORM\UniqueConstraint(name="gacl_value_axo_sections", columns={"value"})}, indexes={@ORM\Index(name="gacl_hidden_axo_sections", columns={"hidden"})})
 * @ORM\Entity
 */
class DpGaclAxoSections
{
    /**
     * @var int
     *
