 ...
 * DpGaclAxo
 *
 * @ORM\Table(name="dp_gacl_axo", uniqueConstraints={@ORM\UniqueConstraint(name="gacl_section_value_value_axo", columns={"section_value", "value"})}, indexes={@ORM\Index(name="gacl_hidden_axo", columns={"hidden"})})
 * @ORM\Entity
 */
class DpGaclAxo
{
