 ...
 * DpGaclAroSections
 *
 * @ORM\Table(name="dp_gacl_aro_sections", uniqueConstraints={@ORM\UniqueConstraint(name="gacl_value_aro_sections", columns={"value"})}, indexes={@ORM\Index(name="gacl_hidden_aro_sections", columns={"hidden"})})
 * @ORM\Entity
 */
class DpGaclAroSections
{
    /**
     * @var int
     *
